...
const checkDiscrepancy = async () => {
  ...
  try {
    ...
    console.log(`   • Закрытые позиции - Реализованная P&L: $${totalClosedRealized.toFixed(2)}`);
    ...
    console.log(`   💰 Вычисленная реализованная прибыль: $${calculatedRealizedPnl.toFixed(2)}`);
